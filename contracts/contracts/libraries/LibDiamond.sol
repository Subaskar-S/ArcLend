 ...
 * @notice EIP-2535 Diamond Standard implementation.
 * @dev Reference implementation: https://github.com/mudgen/diamond-3-hardhat
 */
library LibDiamond {
    ...
    struct DiamondStorage {
        // Maps function selector → (facet address + position in selectorSlots)
    ...
    function replaceFunctions(
        ...
        for (
            ...
            require(
                ...
                "LibDiamond: Can't replace immutable function"
            );
            require(
    ...
    function initializeDiamondCut(
        ...
        if (_init == address(0)) {
            require(
                _calldata.length == 0,
                "LibDiamond: _init is address(0) but _calldata is not empty"
            );
        } else {
            require(
                _calldata.length > 0,
